...
| **Persistent complex menus**                | Discord buttons have limits. Keep interactions to text commands and simple reactions.      |
| **Multi-party simultaneous events**         | Token budget killer. One scene at a time, queued.                                          |
| **Procedural world generation mid-year**    | The world must feel *built*, not generated.<br>Pre-seed locations, let the AI reveal them. |
| **Player-driven economy / crafting system** | This is a narrative game, not an MMO (Yet). Keep items meaningful and rare.                |
...
| **"Let's support 20+ players"**             | Graph DB and token budget don't scale linearly.                                                                         | If the POC works, the sequel campaign can be designed for scale.                                                                                                |
| **"Balancing classes and stats"**           | D&D-style class balance is an infinite timesink.                                                                        | 4/5 broad archetypes. No subclasses. Stats are simple.                                                                                                          |
...
| Discord rate limits on mobile | Low        | Messages delayed or dropped                     | Batch daily-roll results into 1–2 messages max. No rapid-fire updates. Cache LLM responses and resume if chat timed out.    |
