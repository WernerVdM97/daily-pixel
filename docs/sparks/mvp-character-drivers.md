...
alignment: lawful-good          # DERIVED from moral_position (the 3×3 grid) — see [[mvp+moral-drift]]
...
# bonds come from bonded_npc / trusts edges → see [[mvp-social-model]]
```
