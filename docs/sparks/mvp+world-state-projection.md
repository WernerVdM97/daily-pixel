...
The POC `/sleep` lets a player end the day from anywhere, which breaks the fiction. Both fixes below need the world-state this doc projects (location safety, distance, faction).
