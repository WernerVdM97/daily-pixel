...
So combat gets the danger tier, not a DC. That choice has a second payoff beyond honesty: the card and the narration agree on the same word for the round that resolves the fight, instead of the prose and the UI describing difficulty on two unrelated scales.
