...
- [>] **Pipeline split (classify→decide→resolve) + the resolve LLM** → [[prompt-separation-of-concerns]] Thread D. The geography slots under v12's future `travel` template.
