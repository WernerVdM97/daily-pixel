...
- **Choice descriptions in `/join`** — each class, upbringing, race, alignment, day-job, and starting kit now shows its one-line lore in the embed body, not just its name, so players know what they're picking.
