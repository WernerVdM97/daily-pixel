# ⚠️ CURRENT SOURCE — MANUALLY SYNCED

> **This file must always mirror the latest decision prompt** (`decision-v*.md`).
> To update: copy the content of the newest `decision-v*.md` over this file.
>
> The purpose is to have a stable path (`current_source.md`) that always reflects
> the current prompt — making `git diff` between prompt versions trivially easy
> (just run `git diff HEAD~1 -- assets/prompts/decision-prompts/current_source.md`
> or compare across branches/commits).

<!-- ====== BEGIN: mirrored from decision-v5.md ====== -->
<!-- Last synced: 2026-06-16 | Source: decision-v5.md | PROMPT_VERSION: v5 -->
...
<!-- ====== END: mirrored from decision-v5.md ====== -->
