...
### 1. The Nature of Skill Actions
- Training, practice, study, crafting — deliberate, internal actions. The player is working on themselves or their craft, not interacting with external threats.
...
### 3. Scene Framing for Skill
- Set the mood: the quiet of the practice yard, the ache of repetition, the moment something clicks. Skill actions are character moments.
- No danger escalation — these are in safe or controlled environments. If something interrupts (a stranger arrives, a noise in the dark), that's a shift to a different action type.
