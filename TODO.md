...
## ⏭️ RESUME HERE - JSON seam arc: M8 (read-only screens through the seam) — M8.0 screens oracle is the current slice (last touched 2026-08-06)
